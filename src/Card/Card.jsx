    ...
    <PayPalScriptProvider options={{ "client-id": "ARONvZGigACXb-99ytAKPoF-UBvx6dFXzMSiO-QnSgkNFpObnSZham6aKo3UefFjb0t8mQZKxBWGZxgx", currency: "AUD" }}>
      <div className="store-page">
        ...
        <div className="about-us">
          ...
          <p>As we are new, we only have limited stock at this stage.</p>
          <p>Feel free to reach out and contact me if you have any questions or would like to order anything in your size.</p>
        </div>
      </div>
